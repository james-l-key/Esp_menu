...
void menu_init(void) {
  ...
  knob_config_t knob_cfg = {
      .default_direction = 0, .gpio_encoder_a = 5, .gpio_encoder_b = 6};
  ...
  if (iot_button_new_gpio_device(&btn_cfg, &gpio_btn_cfg, &encoder1_btn) !=
      ESP_OK) {
  ...
  lvgl_port_encoder_cfg_t encoder_cfg = {
      .disp = disp, .encoder_a_b = encoder1, .encoder_enter = encoder1_btn};
