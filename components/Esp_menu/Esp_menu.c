...
#define GPIO_BTN_PRESS CONFIG_ENCODER_BUTTON_PIN
#define GPIO_ENCODER_A CONFIG_ENCODER_A_PIN
#define GPIO_ENCODER_B CONFIG_ENCODER_B_PIN
...
void menu_init()
{
    ...
    esp_lcd_panel_io_i2c_config_t io_config = {
        .dev_addr = 0x3C,         // SSD1306 address, typically 0x3C or 0x3D
    ...
    gpio_config_t io_conf = {
        ...
        .pin_bit_mask = (1ULL << CONFIG_ENCODER_A_PIN) |
                        (1ULL << CONFIG_ENCODER_B_PIN) |
                        (1ULL << CONFIG_ENCODER_BUTTON_PIN),
    ...
    // If you need to store encoder_handle for later use,
    // save it in a global variable
    // global_encoder_handle = encoder_handle;
}
